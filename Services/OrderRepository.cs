...
public class OrderRepositiry : IOrderRepository
{
    private readonly McDataBaseContext ctx;
    public OrderRepositiry(McDataBaseContext ctx)
        => this.ctx = ctx;
    ...
    private Task<ClientOrder> getOrder(int orderId)
    {
        var orders =
        ...
        return orders.FirstOrDefaultAsync();
    }
}